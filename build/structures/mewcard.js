    ...
    async build() {
        ...
        if (this.theme == 'mewwme') {
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            throw new Error('Invalid theme parameter, must be "mewwme" | "bebe" | "themes1" | "themes2" | "themes3" | "themes4" | "themes5" | "themes6" | "themes7" | "themes8" | "themes9" | "themes10" | "themes11" | "themes12" | "themes13" | "themes14" | "themes15" | "themes16" | "themes17" | "themes18" | "mewwme1" | "themes19" | "miko" | "blank"');
        }
    }
}
